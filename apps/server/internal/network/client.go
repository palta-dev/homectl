...
// dialContext wraps dialer with SSRF checks and pins the IP to prevent DNS rebinding
func (c *Client) dialContext(ctx context.Context, network, addr string) (net.Conn, error) {
	...
	// Pin to the first IP to prevent DNS rebinding attacks
	...
	// Use the pinned IP for the actual connection
