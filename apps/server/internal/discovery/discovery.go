...
func isWebPort(port int) bool {
	webPorts := map[int]bool{
		...
		5177: true, 7777: true, 8000: true, 8001: true, 8008: true,
		8080: true, 8081: true, 8082: true, 8083: true, 8088: true, 8123: true,
...
func (d *Discoverer) identifyService(port int) string {
	wellKnownPorts := map[int]string{
		...
		5175: "Vite", 5176: "Vite", 5177: "Vite", 7777: "homectl",
		8000: "HTTP-Dev", 8001: "HTTP-Dev", 8008: "HTTP-Alt", 8080: "HTTP-Proxy",
